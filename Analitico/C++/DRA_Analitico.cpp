...
void DRA_Analitico(const Bombeio& bombeio, const Sinal& sinal, const Fibra& fibra, double& ripple, double& Ganho_Medio, double& Ganho_on_off_medio, double * Ganho_on_off)
{
...
void mexFunction(int nlhs,mxArray *plhs[],int nrhs,const mxArray *prhs[])
{
    ...
    double ripple, Ganho_Medio, Ganho_on_off_medio, * Ganho_on_off; //Saída
    ...
    if(nlhs != 4)
        mexErrMsgTxt("A função deve ter quatro saídas (ripple,Ganho_Medio,Ganho_on_off_medio, GA_sinaldB)");
    ...
    DRA_Analitico(bombeio,sinal,fibra,ripple,Ganho_Medio,Ganho_on_off_medio,Ganho_on_off);
