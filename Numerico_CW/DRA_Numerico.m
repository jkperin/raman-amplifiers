...
[ripple_an,Ganho_Medio_an,Ganho_on_off_medio_an, Ganho_on_off_an, Ppumpch] = DRA_Analitico_num(bombeio,sinal,fibra);
...
resultados_an.Ganho_on_off = Ganho_on_off_an;
...
%% Dados invariáveis
x = linspace(0,fibra.L,100);         % Vetor posição
Pos = sinal.P;
