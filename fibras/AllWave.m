...
function fibra = AllWave(bombeio, sinal)
...
% 
% Allwave = [0.270 0.248 0.232 0.218 0.209 0.200 0.192 0.186 0.182 0.181 ...
%     0.184 0.193 0.208 0.234 0.276];
% 
% polyAllwave = polyfit(sepfreq,Allwave,4);

polyAllwave = [1.091191445228919e-10,-6.580860301432476e-07,0.001489899298771,-1.501124010303977,5.682369670622743e+02];

fibra.alfasdBkm = polyval(polyAllwave, sinal.lambda);
fibra.alfapdBkm = polyval(polyAllwave, bombeio.lambda);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
lambdap_ref    = 1455;
Crpico_refp    = 0.36;  %(W^-1*km^-1) Coeficiente de Raman de pico 
...
%
lambdas_ref    = 1455;
Crpico_refs    = 0.36;  %(W^-1*km^-1) Coeficiente de Raman de pico 
