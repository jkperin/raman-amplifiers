...
function fibra = Corning_DSF(bombeio, sinal)
...
% 
% Corning_DSF = [0.30 0.254 0.233 0.22 0.209 0.201 0.195 0.193 0.195 0.203 ... 
%     0.218 0.247];
% 
% polyCorning_DSF = polyfit(sepfreq,Corning_DSF,5);

polyCorning_DSF = [-1.814668180888996e-12,1.439056505609139e-08,-4.559712452023455e-05,0.072164781569967,-57.053130511173990,1.802735185567989e+04];

fibra.alfasdBkm = polyval(polyCorning_DSF, sinal.lambda);
fibra.alfapdBkm = polyval(polyCorning_DSF, bombeio.lambda);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
lambdap_ref    = 1455;
Crpico_refp    = 0.67;  %(W^-1*km^-1) Coeficiente de Raman de pico 
...
%
lambdas_ref    = 1455;
Crpico_refs    = 0.67;  %(W^-1*km^-1) Coeficiente de Raman de pico 
