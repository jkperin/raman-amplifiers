...
function fibra = Corning_NZDSF(bombeio, sinal)
...
% 
% Corning_NZDSF = [0.280 0.252 0.232 0.219 0.206 0.198 0.193 ...
%     0.190 0.192 0.199 0.219 0.246];
% 
% polyCorning_NZDSF = polyfit(sepfreq,Corning_NZDSF,4);

polyCorning_NZDSF = [1.764186334862795e-10,-1.082723266544934e-06,0.002495083497767,-2.559159328209145,9.860905308122664e+02];

fibra.alfasdBkm = polyval(polyCorning_NZDSF, sinal.lambda);
fibra.alfapdBkm = polyval(polyCorning_NZDSF, bombeio.lambda);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
lambdap_ref    = 1455;
Crpico_refp    = 0.72;  %(W^-1*km^-1) Coeficiente de Raman de pico 
...
%
lambdas_ref    = 1455;
Crpico_refs    = 0.72;  %(W^-1*km^-1) Coeficiente de Raman de pico 
...
Aeff_lambda_ref = 50;  %Livro Mohammed Islam, pg 115
...
fibra.NA = 0.14; % abertura numerica da fibra (Confirmado - Datasheet) 
fibra.no = 1.468;  %NA^2/(2*deltaindice);  % indice de refracao do nucleo da fibra (Confirmado - Datasheet)
