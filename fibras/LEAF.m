...
function fibra = LEAF(bombeio, sinal)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                               Atenuação                               %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% sepfreq = 1420:20:1680;
% 
% LEAF = [0.280 0.253 0.230 0.214 0.204 0.198 0.190 0.185 0.186 0.186 0.192...
%     0.214 0.240 0.276];
% 
% polyLEAF = polyfit(sepfreq,LEAF,4);

polyLEAF = [1.395012769154649e-10,-8.539149270228418e-07,0.001962853688986,-2.008392179603955,7.721093837771216e+02];


fibra.alfasdBkm = polyval(polyLEAF, sinal.lambda);
fibra.alfapdBkm = polyval(polyLEAF, bombeio.lambda);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
lambdap_ref    = 1455;
Crpico_refp    = 0.46;  %(W^-1*km^-1) Coeficiente de Raman de pico 
...
%
lambdas_ref    = 1455;
Crpico_refs    = 0.46;  %(W^-1*km^-1) Coeficiente de Raman de pico 
...
Aeff_lambda_ref = 75;  %Livro Mohammed Islam, pg 115
